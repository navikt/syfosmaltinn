    ...
    FunSpec({
        ...
        context("PdfPayloadMapper") {
            test("Mapper sykmelding med tre perioder riktig") {
                ...
                pdfPayload.arbeidsgiverSykmelding.arbeidsgiverNavn shouldBeEqualTo
                    "ArbeidsgiverNavn"
            ...
            test("Mapper sykmelding med en periode riktig") {
                val sykmeldingId = UUID.randomUUID().toString()
                val perioder =
                    listOf(
                        SykmeldingsperiodeAGDTO(
                ...
                val sykmeldingsperiode =
                    pdfPayload.arbeidsgiverSykmelding.sykmeldingsperioder.first()
