...
fun main() {
    ...
    val stsOidcClient = StsOidcClient(username = vaultSecrets.serviceuserUsername, password = vaultSecrets.serviceuserPassword)
    ...
    val narmestelederClient = NarmestelederClient(httpClient, accessTokenClient)
