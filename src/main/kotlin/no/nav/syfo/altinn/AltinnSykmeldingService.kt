...
import no.nav.syfo.altinn.reporteeresolver.AltinnReporteeResolver
import no.nav.syfo.log
import no.nav.syfo.narmesteleder.model.NarmesteLeder
import no.nav.syfo.pdl.client.model.Person
import no.nav.syfo.sykmelding.kafka.model.SendtSykmeldingKafkaMessage

class AltinnSykmeldingService(private val altinnClient: AltinnClient, private val environment: Environment, private val altinnReporteeResolver: AltinnReporteeResolver) {
